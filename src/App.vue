<template>
  <v-app dark>
    ...
    <v-container>
      <v-layout class="font-weight-bold display-3 white--text" justify-center mb-4>Match Pairs</v-layout>
      <v-layout mb-4>
...
// Doubles the images to make them pairs and shuffles them all
let shuffleCards = () => {
  let cards = [].concat(_.cloneDeep(cardsSet), _.cloneDeep(cardsSet));
  return _.shuffle(cards);
};

// import our components and register them in the components object. We also import Lodash and Moment.
